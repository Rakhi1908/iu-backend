...
//       const newAdmin = await apiCall("/admins", {
//         method: "POST",
...
//       const updatedAdmin = await apiCall(`/admins/${currentAdmin.id}`, {
//         method: "PUT",
//         body: JSON.stringify(adminData),
//       })

//       // Update the admin in local state
//       setAdmins((prev) => prev.map((admin) => (admin.id === currentAdmin.id ? { ...admin, ...updatedAdmin } : admin)))
...
//       setAdmins((prev) => prev.map((admin) => (admin.id === id ? { ...admin, status: newStatus } : admin)))
