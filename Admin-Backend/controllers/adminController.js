...
//   id: admin._id.toString(), // Convert to string for frontend
...
//     // Transform admins for frontend compatibility
...
//     console.log("Get Admin By ID - Received ID:", id, "Type:", typeof id)
...
//     // Return the transformed admin directly (not wrapped in data object)
...
//     console.log("Update Admin - Received ID:", id, "Type:", typeof id)
...
//     // Return the transformed admin directly
//     res.json(transformAdmin(adminResponse))
//   } catch (error) {
...
//     console.log("Delete Admin - Received ID:", id, "Type:", typeof id)

//     // Check if ID is undefined, null, or empty
//     if (!id || id === "undefined" || id === "null" || id.trim() === "" || id === undefined || id === null) {
//       console.log("Delete Admin - Invalid ID detected:", id)
//       return res.status(400).json({
//         success: false,
...
//     if (!isValidObjectId(id)) {
//       console.log("Delete Admin - Invalid ObjectId format:", id)
//       return res.status(400).json({
//         success: false,
...
//     console.log("Delete Admin - Successfully deleted:", admin.name)
...
//     console.log("Update Status - Received ID:", id, "Type:", typeof id)
...
//     console.log("Update Status - Successfully updated:", admin.name, "to", status)

//     res.json({
//       success: true,
//       message: `Admin status updated to ${status}`,
//       data: transformAdmin(updatedAdmin),
//     })
//   } catch (error) {
...
const Admin = require("../models/adminModel")
const mongoose = require("mongoose")
const { emitAdminEvent } = require("../socket/socketManager")
...
const updateAdminStatus = async (req, res) => {
  try {
    ...
    // 🔥 EMIT REAL-TIME EVENT
    emitAdminEvent("admin:status-changed", {
